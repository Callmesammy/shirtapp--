...
function Navbar() {
  ...
  return (
    ...
    <div className="bg-maint z-20 top-0 sticky shadow-sm">
      <div className="container grid-cols-7 lg:grid mx-auto px-4 py-6 gap-10 items-center justify-center text-white">
         {/*Logo*/}
    ...
    {/*Menu*/}
    <div className="col-span-3 font-medium text-sm justify-between xl:gap-14 2xl:gap-20 lg:flex hidden xl:justify-end items-center">
     ...
     <div className="w-5 h-5 flex-colo rounded-full bg-sub text-white text-xs absolute -top-5 -right-2">
      4
     </div>
      </NavLink>
    </div>
