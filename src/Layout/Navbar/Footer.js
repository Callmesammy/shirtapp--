...
function Footer() {
  ...
  return (
    ...
    {Footers.map((footer, index) => (
      <div key={index} className="col-span-1 md:span-2 lg:span-3 xl:span-3 pb-3.5 sm:pb-0">
    <h3 className="text-white lg:leading-7 mb-4 text-normal col-span-3 font-bold">
      {footer.title}</h3>
      </div>
    ))}
    </div>
