...
function Footer() {
  ...
  return (
    ...
    <div className="grid sm:grid-cols-5 md:grid-cols-9 xl:grid-cols-12 gap-5 sm:gap-6 md:gap-7 xl:gap-14 py-4 justify-between pb-3.5 sm:pb-0">
    ...
    <div className="pb-3.5 col-span-1 md:col-span-2 lg:col-span-3 sm:pb-0">
      ...
      <p className="text-sm text-brd items-center">Lorem ipasum dummy text <br/> Donny</p>
    </div>
    </div>
